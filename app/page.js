...
export default async function Home() {
  return (
    <div>
      ...
      <section className="w-full border-y-[#8B4F4F] border-y-2 py-10 my-14 flex flex-col items-center gap-8">
      ...
      <section className="w-full py-14 flex lg:px-16 items-center">
      ...
      <section className="flex py-20 justify-center md:justify-around items-center">
        <div>
          <h2 className="text-col2 text-6xl font-ff1 pb-16">Try it yourself</h2>
          <div className="flex flex-col gap-8 items-center">
            <p className="text-xl w-[26ch]">
              <span className="inline-block">
                Visit us at Block 69 Epstein Island
              </span>{" "}
